...
cover: /images/posts/db-graph-mcp.ja.cover.png
---
...
作ってみて実感したのは、**MCPの本質的な価値は「AIにコンテキストを与えること」だ**ということです。テーブル構造、リレーション、Enum定義、カラムの注意書き — これらがAIのコンテキストに入ることで、Claude Codeが書くSQLやコードの精度が格段に上がります。
