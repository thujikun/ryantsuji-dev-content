...
そして最後の**Part 6**は連載全体の総括として、「**全然簡単じゃない**」「**失敗の総量から学んだ構造**」を書く予定です。記事ではここまで「うまく回っている結果」を中心に書いてきましたが、その裏には踏んできた失敗・つまずきの量があり、それを整理してこそ「ハーネスを真似したい人」に対する実用的な地図になる、と考えています。
