...
emoji: "✂️"
type: tech
topics: ["ai", "architecture", "claude", "mcp", "oauth"]
published: true
publication_name: "aircloset"
---

:::message
[English Version is here](https://ryantsuji.dev/posts/mcp-parking-pattern?lang=en)
:::
...
![素直に実装するとコンテキストが膨らむ](https://ryantsuji.dev/images/posts/mcp-parking-pattern/fddd2b2c562f-20260501.png?v=a0c3cf2e)
...
![退避パターン](https://ryantsuji.dev/images/posts/mcp-parking-pattern/f7a4e261e122-20260501.png?v=9ea08d0a)

エアークローゼットでの実例を2つ紹介します。

## 例1：リクエストを軽くする ── Sandbox MCP × 自前Git Server

[Sandbox MCP](https://zenn.dev/aircloset/articles/65efe9614f8e73)（非エンジニア向けにアプリを社内公開できるプラットフォーム）は、最初は**MCPツールでファイルを送る**設計でした。
...
![Google Workspace OAuthで一石二鳥](https://ryantsuji.dev/images/posts/mcp-parking-pattern/8e441f4d82c4-20260501.png?v=f61a26a7)
