...
![ハッシュ化を書き込みと検索の両端で通すことで、平文PIIを観測スタックに入れずに検索できる](https://ryantsuji.dev/images/posts/ai-observability-practice/pii-round-trip.png?v=343dfccf)
...
![同じObservable基盤(Prometheus / BQ / Loki)を、人間はWebダッシュボードから、AIはMCPから引く](https://ryantsuji.dev/images/posts/ai-observability-practice/integrated-surface.png?v=ae7632e7)
