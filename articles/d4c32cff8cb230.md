...
![4つの監視対象を、それぞれ問いの質に合わせて別の形でAIに渡す](https://ryantsuji.dev/images/posts/ai-observability-design/four-axes-framework.png?v=cf66c4a3)
...
![CIログをwebhook pushでなくpost-hoc pullで流す](https://ryantsuji.dev/images/posts/ai-observability-design/ci-log-pull-vs-push.png?v=2bdac5e4)
...
![Claude Code利用量ダッシュボード — 過去30日で77.1Bトークン、cache読込が96% を占める](https://ryantsuji.dev/images/posts/ai-observability-design/cc-usage-dashboard.png?v=d2927e7b)
