...
emoji: "🦺"
type: tech
topics: ["ai", "claude", "cloudflare", "mcp", "typescript"]
published: true
publication_name: "aircloset"
---

:::message
[English Version is here](https://ryantsuji.dev/posts/sandbox-mcp?lang=en)
:::

みなさまこんにちは！エアークローゼットでCTOをしている[辻](https://x.com/RyanAircloset)です。

これまでに[DB Graph MCP](https://zenn.dev/aircloset/articles/2731787582881a)、[社内MCP群の全体像](https://zenn.dev/aircloset/articles/d9fc317c1336c2)、[Biz Graph MCP](https://zenn.dev/aircloset/articles/7a0b06cb2a35d8)と、社内向けに作っているMCPサーバーを順に紹介してきました。
...
![System Overview](https://ryantsuji.dev/images/posts/sandbox-mcp/333f7e179c20-20260430.png?v=90a5ce13)
...
![Deploy Flow](https://ryantsuji.dev/images/posts/sandbox-mcp/d0069340db94-20260430.png?v=0f9f2040)
...
![URL Routing](https://ryantsuji.dev/images/posts/sandbox-mcp/581144c2932b-20260430.png?v=ca27dc06)
...
![Security Layers](https://ryantsuji.dev/images/posts/sandbox-mcp/a5947d51b590-20260430.png?v=5aed98d0)
