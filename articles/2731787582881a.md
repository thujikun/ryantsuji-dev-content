...
emoji: "💽"
type: tech
topics: ["ai", "claudecode", "graphrag", "mcp", "security"]
published: true
publication_name: "aircloset"
---

:::message
[English Version is here](https://ryantsuji.dev/posts/db-graph-mcp?lang=en)
:::
...
![System Overview](https://ryantsuji.dev/images/posts/db-graph-mcp/3d4264644082-20260326.png?v=dff4a5fc)
...
![レビューUI — テーブル詳細画面](https://ryantsuji.dev/images/posts/db-graph-mcp/c782be1fb016-20260326.png?v=5c4d4927)
...
![Query Dataflow](https://ryantsuji.dev/images/posts/db-graph-mcp/0c2520205373-20260326.png?v=5bdba31a)
...
![Credential Flow](https://ryantsuji.dev/images/posts/db-graph-mcp/9d0a50f0d1eb-20260326.png?v=1cd581ba)
