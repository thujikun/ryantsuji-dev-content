...
![Before / After — コードからの推論だけで作ったグラフ vs JSDocをSSoTにしたナレッジグラフ](https://ryantsuji.dev/images/posts/cortex-product-graph/before-after-ssot.png)
...
![ビルドパイプライン — JSDoc · Pulumi · docsから1つのナレッジグラフを組み立てる](https://ryantsuji.dev/images/posts/cortex-product-graph/build-pipeline.png)
...
![Product Graph — 4レイヤーが同じノード集合に乗ったナレッジグラフ](https://ryantsuji.dev/images/posts/cortex-product-graph/knowledge-graph-structure.png)
...
![Runbookパターン — ツール返却値に「次に叩くべきツール呼び出し」が同梱される](https://ryantsuji.dev/images/posts/cortex-product-graph/runbook-flow.png)
