...
[前編](https://zenn.dev/aircloset/articles/a7cf65cc035572)で、46リポジトリに跨る本番システムのコードベースを静的解析で1つのナレッジグラフに統合した話を書きました。 完成はしたものの、 最後に残った課題4つを挙げ、 そのうち特に改善したかったのが **「セマンティック検索ができない (入口問題)」** だと書きました。
