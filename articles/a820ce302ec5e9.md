...
emoji: "🔎"
type: tech
topics: ["ai", "gcp", "googlemeet", "rag", "typescript"]
published: true
publication_name: "aircloset"
---

:::message
[English Version is here](https://ryantsuji.dev/posts/meeting-intelligence?lang=en)
:::

みなさまこんにちは！エアークローゼットでCTOをしている[辻](https://x.com/RyanAircloset)です。

これまでに、社内の全DBを自然言語で検索できる[DB Graph MCP](https://zenn.dev/aircloset/articles/2731787582881a)と、17台のMCPサーバー群で社内業務をAIに開放した[MCPサーバー群](https://zenn.dev/aircloset/articles/d9fc317c1336c2)を紹介しました。おかげさまでどちらも多くの反響をいただきました。
...
![Google Calendarに表示されるChrome拡張ボタン](https://ryantsuji.dev/images/posts/meeting-intelligence/97aa336464de-20260411.png?v=2f0a6b67)
*Google Meetのビデオ会議追加の横に、Chrome拡張の「AI Fassy Meet」ボタンが表示される*

通知先のSlackチャンネルを選択します。過去に選択したチャンネルが上位に、よく使うチャンネルがその下に並びます。

![Slackチャンネル選択ダイアログ](https://ryantsuji.dev/images/posts/meeting-intelligence/7ffdc74c6ccf-20260411.png?v=f109822a)
*チャンネル検索・選択ダイアログ。選択履歴とアクティビティに基づいてソートされている*

「Meetを作成」をクリックすると、Meet URLがCalendar予定に自動設定されます。

![Meet URL設定中](https://ryantsuji.dev/images/posts/meeting-intelligence/d1d167ec9b6f-20260411.png?v=e9202af7)
...
![Slack会議終了通知](https://ryantsuji.dev/images/posts/meeting-intelligence/7a1060fb045c-20260411.png?v=30fa4bff)
...
![スレッド全体の流れ：終了通知→アーティファクト通知→RAG検索→回答](https://ryantsuji.dev/images/posts/meeting-intelligence/6583506b0fbd-20260411.png?v=310baf14)
...
![System Overview](https://ryantsuji.dev/images/posts/meeting-intelligence/910e98f533b7-20260411.png?v=961e9452)
...
![LIFO Cache](https://ryantsuji.dev/images/posts/meeting-intelligence/a13c0e0ea06d-20260411.png?v=8d7c4fd9)
...
![Event Pipeline](https://ryantsuji.dev/images/posts/meeting-intelligence/d5455965165f-20260411.png?v=40f04561)
...
![Permission Model](https://ryantsuji.dev/images/posts/meeting-intelligence/b7aed56354a1-20260411.png?v=194dd6e0)
...
![RAG Pipeline](https://ryantsuji.dev/images/posts/meeting-intelligence/7ec3f8143e47-20260411.png?v=96c2926d)
...
また、[以前の記事](https://zenn.dev/aircloset/articles/d9fc317c1336c2)で紹介したGrafana MCPを通じて、これらのログやメトリクスにMCP経由でもアクセス可能です。「昨日のMeetパイプラインでエラーが出たログを見せて」といった調査がClaude Codeから直接できます。
...
エアークローゼットでは、プロジェクト単位でSlackチャンネルが作成されています。このチャンネルとプロジェクトの紐づきはFirestoreで管理されており、[以前の記事](https://zenn.dev/aircloset/articles/d9fc317c1336c2)で紹介したProject Management MCPからは、**プロジェクトに紐づく会議データをMCP経由で横断検索**できるようになっています。
