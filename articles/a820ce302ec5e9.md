...
![Google Calendarに表示されるChrome拡張ボタン](https://ryantsuji.dev/images/posts/meeting-intelligence/97aa336464de-20260411.png)
*Google Meetのビデオ会議追加の横に、Chrome拡張の「AI Fassy Meet」ボタンが表示される*

通知先のSlackチャンネルを選択します。過去に選択したチャンネルが上位に、よく使うチャンネルがその下に並びます。

![Slackチャンネル選択ダイアログ](https://ryantsuji.dev/images/posts/meeting-intelligence/7ffdc74c6ccf-20260411.png)
*チャンネル検索・選択ダイアログ。選択履歴とアクティビティに基づいてソートされている*

「Meetを作成」をクリックすると、Meet URLがCalendar予定に自動設定されます。

![Meet URL設定中](https://ryantsuji.dev/images/posts/meeting-intelligence/d1d167ec9b6f-20260411.png)
...
![Slack会議終了通知](https://ryantsuji.dev/images/posts/meeting-intelligence/7a1060fb045c-20260411.png)
...
![スレッド全体の流れ：終了通知→アーティファクト通知→RAG検索→回答](https://ryantsuji.dev/images/posts/meeting-intelligence/6583506b0fbd-20260411.png)
...
![System Overview](https://ryantsuji.dev/images/posts/meeting-intelligence/910e98f533b7-20260411.png)
...
![LIFO Cache](https://ryantsuji.dev/images/posts/meeting-intelligence/a13c0e0ea06d-20260411.png)
...
![Event Pipeline](https://ryantsuji.dev/images/posts/meeting-intelligence/d5455965165f-20260411.png)
...
![Permission Model](https://ryantsuji.dev/images/posts/meeting-intelligence/b7aed56354a1-20260411.png)
...
![RAG Pipeline](https://ryantsuji.dev/images/posts/meeting-intelligence/7ec3f8143e47-20260411.png)
