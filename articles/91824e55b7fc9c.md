...
emoji: "🤖"
type: tech
topics: ["ai", "codereview", "devops", "github", "typescript"]
published: false
publication_name: "aircloset"
---

:::message
[English Version is here](https://ryantsuji.dev/posts/cortex-auto-review?lang=en)
:::
...
[Part 1（総論）](https://zenn.dev/aircloset/articles/d416342f46f16b)で **AIがPRレビューや障害対応を回している**話を、[Part 2（Product Graph）](https://zenn.dev/aircloset/articles/f6c990989e60d4)で **コード・docs・DB・インフラを1つのナレッジグラフに統合した cpg** の話を書きました。
...
1. **AIに渡すコンテキストが十分であること** ── コード本体だけ見せても、ビジネス的な意味・上流下流の依存・過去の障害履歴が見えない。これは [Part 2](https://zenn.dev/aircloset/articles/f6c990989e60d4) で書いた **Product Graph (cpg)** が解決済みです。
...
![Auto Review 全フロー — PR 起票から自動 deploy まで人なしで完結](https://ryantsuji.dev/images/posts/cortex-auto-review/auto-review-flow.png)
...
![review-fix loop の実例 — PR #1241 / 1.5時間 で 6 iteration](https://ryantsuji.dev/images/posts/cortex-auto-review/review-fix-timeline.png)
...
![Before / After — 人レビュー時代 vs cortex の Auto Review 時代](https://ryantsuji.dev/images/posts/cortex-auto-review/before-after-review.png)
